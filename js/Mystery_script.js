...
function fall_wood_interval2(){
    ...
    gravitySpeed2 *= 0.98 * ma_obj["Aluminium"];
...
function fall_wood_interval3(){
    ...
    gravitySpeed3 *= 0.98 * ma_obj["Brick"];
...
function getGravity1(){
    ...
    if(document.getElementById("wood1").getBoundingClientRect().top > document.getElementById("water").getBoundingClientRect().top){
        return -dec_obj["Ice"] * amp1;
    }
    
    return  (inc_obj["Ice"] - (inc_obj["Ice"] + dec_obj["Ice"]) * put_height1 / pieceHeight1) * amp1;
}
...
function getGravity2(){
    ...
    if(document.getElementById("wood2").getBoundingClientRect().bottom < document.getElementById("water").getBoundingClientRect().top){
        return inc_obj["Aluminium"];
    }

    if(document.getElementById("wood2").getBoundingClientRect().top > document.getElementById("water").getBoundingClientRect().top){
        return -dec_obj["Aluminium"] * amp2;
    }
    
    return  (inc_obj["Aluminium"] - (inc_obj["Aluminium"] + dec_obj["Aluminium"]) * put_height2 / pieceHeight2) * amp2;
}
...
function getGravity3(){
    ...
    if(document.getElementById("wood3").getBoundingClientRect().top > document.getElementById("water").getBoundingClientRect().top){
        return -dec_obj["Brick"] * amp3;
    }
    
    return  (inc_obj["Brick"] - (inc_obj["Brick"] + dec_obj["Brick"]) * put_height3 / pieceHeight3) * amp3;
}
...
function Water_Change(){
    ...
    height1 = document.getElementById("wood1").getBoundingClientRect().bottom - document.getElementById("water").getBoundingClientRect().top;

    if(document.getElementById("wood1").getBoundingClientRect().top >= document.getElementById("water").getBoundingClientRect().top){
        height1 = document.getElementById("wood1").getBoundingClientRect().height;
    }
    if(document.getElementById("wood1").getBoundingClientRect().bottom <= document.getElementById("water").getBoundingClientRect().top){
        height1 = 0;
    }
    ...
    moveL1 = 4.35 * moveL1 / objHeight;
    moveL += moveL1;

    var height2;

    height2 = document.getElementById("wood2").getBoundingClientRect().bottom - document.getElementById("water").getBoundingClientRect().top;

    if(document.getElementById("wood2").getBoundingClientRect().top >= document.getElementById("water").getBoundingClientRect().top){
        height2 = document.getElementById("wood2").getBoundingClientRect().height;
    }
    if(document.getElementById("wood2").getBoundingClientRect().bottom <= document.getElementById("water").getBoundingClientRect().top){
        height2 = 0;
    }
    ...
    moveL2 = 2.67 * moveL2 / objHeight;

    moveL += moveL2 / 4;

    var height3;

    height3 = document.getElementById("wood3").getBoundingClientRect().bottom - document.getElementById("water").getBoundingClientRect().top;

    if(document.getElementById("wood3").getBoundingClientRect().top >= document.getElementById("water").getBoundingClientRect().top){
        height3 = document.getElementById("wood3").getBoundingClientRect().height;
    }
    if(document.getElementById("wood3").getBoundingClientRect().bottom <= document.getElementById("water").getBoundingClientRect().top){
        height3 = 0;
    }
...
function dragElement(elmnt) {
  ...
  function elementDrag(e) {
    ...
    // clearInterval(myTimer1);
    // myTimer1 = setInterval(fall_wood_interval1, 10);
    if(validateRect("wood")){
        if(!objArray.includes("woodheader")){
            objArray.push("woodheader");
        }
    }
    else{
        if(objArray.includes("woodheader")){
            var index = objArray.indexOf("woodheader");
            if(index > -1){
    ...
    if(objArray.length == 0){
        ...
        for(var i = 0;i < objArray.length;i ++){
            tempVal += parseFloat($("#"+objArray[i]).children("span").html());
        }

        $("#panel").html(tempVal.toFixed(2));
    }
  ...
  function closeDragElement() {
    if($("#wood1").attr("y") > 177){
        if(!objArray.indexOf("#woodheader1")){
            amp1 = 1;
            clearInterval(myTimer1);
            myTimer1 = setInterval(fall_wood_interval1, 10); 
        }
    ...
    if($("#wood2").attr("y") > 177){
        if(!objArray.indexOf("#woodheader2")){
            amp2 = 1;
            clearInterval(myTimer2);
            myTimer2 = setInterval(fall_wood_interval2, 10);
        }
    ...
    if($("#wood3").attr("y") > 177){
        if(!objArray.indexOf("#woodheader3")){
            amp3 = 1;
            clearInterval(myTimer3);
            myTimer3 = setInterval(fall_wood_interval3, 10);
        }
    ...
    if(validateRect("wood")){
        ...
        $("#wood").attr('y', parseFloat($("#kk").attr('y')) - parseFloat($("#wood").attr("height")));
    }
    else{
        if(objArray.includes("woodheader")){
            amp = 1;
            myTimer = setInterval(myTimer);
            var index = objArray.indexOf("woodheader");
            if(index > -1){
                objArray.splice(index, 1);
            }
...
function dragElement1(elmnt) {
  ...
  function elementDrag1(e) {
    ...
    if(validateRect("wood1")){
        if(!objArray.includes("woodheader1")){
            objArray.push("woodheader1");
        }
    }
    else{
        if(objArray.includes("woodheader1")){
            var index = objArray.indexOf("woodheader1");
            if(index > -1){
                objArray.splice(index, 1);
            }
        }
  ...
  function closeDragElement1() {
    if($("#wood").attr("y") > 177){
        if(!objArray.indexOf("#woodheader")){
            amp = 1;
            clearInterval(myTimer);
            myTimer = setInterval(fall_wood_interval, 10);
        }
    ...
    if(validateRect("wood1")){
        ...
        $("#wood1").attr('y', parseFloat($("#kk").attr('y')) - parseFloat($("#wood1").attr("height")));
    }
    else{
        if(objArray.includes("woodheader1")){
            amp1 = 1;
            myTimer1 = setInterval(myTimer1);
            var index = objArray.indexOf("woodheader1");
            if(index > -1){
                objArray.splice(index, 1);
            }
...
function dragElement2(elmnt) {
  ...
  function elementDrag2(e) {
    ...
    if(validateRect("wood2")){
        if(!objArray.includes("woodheader2")){
            objArray.push("woodheader2");
        }
    }
    else{
        if(objArray.includes("woodheader2")){
            var index = objArray.indexOf("woodheader2");
            if(index > -1){
                objArray.splice(index, 1);
            }
        }
  ...
  function closeDragElement2() {
    ...
    if(validateRect("wood2")){
        ...
        $("#wood2").attr('y', parseFloat($("#kk").attr('y')) - parseFloat($("#wood2").attr("height")));
    }
    else{
        if(objArray.includes("woodheader2")){
            amp2 = 1;
            myTimer2 = setInterval(myTimer2);
            var index = objArray.indexOf("woodheader2");
            if(index > -1){
                objArray.splice(index, 1);
            }
...
function dragElement3(elmnt) {
  ...
  function elementDrag3(e) {
    ...
    if(validateRect("wood3")){
        if(!objArray.includes("woodheader3")){
            objArray.push("woodheader3");
        }
    }
    else{
        if(objArray.includes("woodheader3")){
            var index = objArray.indexOf("woodheader3");
            if(index > -1){
                objArray.splice(index, 1);
            }
        }
  ...
  function closeDragElement3() {
    ...
    if(validateRect("wood3")){
        ...
        $("#wood3").attr('y', parseFloat($("#kk").attr('y')) - parseFloat($("#wood3").attr("height")));
    }
    else{
        if(objArray.includes("woodheader3")){
            amp3 = 1;
            myTimer3 = setInterval(myTimer3);
            var index = objArray.indexOf("woodheader3");
            if(index > -1){
                objArray.splice(index, 1);
            }
    ...
    if(objArray.length == 0){
        ...
        for(var i = 0;i < objArray.length;i ++){
            tempVal += parseFloat($("#"+objArray[i]).children("span").html());
            console.log(parseFloat($("#"+objArray[i]).children("span").html()));
            console.log(objArray);
        }
...
function validateRect(val){
    if((parseFloat($("#"+val).attr("y")) + parseFloat($("#"+val).attr("height"))) >= parseFloat(315) && (parseFloat($("#"+val).attr("y")) + parseFloat($("#"+val).attr("height"))) <= parseFloat(325) && (parseFloat($("#"+val).attr("x"))) <= parseFloat(90)){
        return 1;
    }
